...
export const feedlightpb = $root.feedlightpb = (() => {

    /**
     * Namespace feedlightpb.
     * @exports feedlightpb
     * @namespace
     */
    const feedlightpb = {};

    feedlightpb.Feedback = (function() {
         ...
         * @constructor
         * @param {feedlightpb.IFeedback=} [properties] Properties to set
         */
         ...
         * @instance
         */
        Feedback.prototype.similar = false;

        /**
         * Feedback dissimilar.
         * @member {boolean} dissimilar
         * @memberof feedlightpb.Feedback
         * @instance
         */
        Feedback.prototype.dissimilar = false;
         ...
         * @instance
         */
        Feedback.prototype.response = "";

        /**
         * Feedback sharePublicly.
         * @member {boolean} sharePublicly
         * @memberof feedlightpb.Feedback
         * @instance
         */
         ...
         * @static
         * @param {feedlightpb.IFeedback=} [properties] Properties to set
         * @returns {feedlightpb.Feedback} Feedback instance
         */
        ...
        /**
         * Encodes the specified Feedback message. Does not implicitly {@link feedlightpb.Feedback.verify|verify} messages.
         * @function encode
         * @memberof feedlightpb.Feedback
         * @static
         * @param {feedlightpb.IFeedback} message Feedback message or plain object to encode
        ...
        Feedback.encode = function encode(message, writer) {
            ...
            if (message.dissimilar != null && message.hasOwnProperty("dissimilar"))
                writer.uint32(/* id 4, wireType 0 =*/32).bool(message.dissimilar);
        ...
        /**
         * Encodes the specified Feedback message, length delimited. Does not implicitly {@link feedlightpb.Feedback.verify|verify} messages.
         ...
         * @returns {feedlightpb.Feedback} Feedback
        ...
        Feedback.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.feedlightpb.Feedback();
            while (reader.pos < end) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.dissimilar = reader.bool();
                    break;
                case 5:
        ...
        Feedback.verify = function verify(message) {
            ...
            if (message.dissimilar != null && message.hasOwnProperty("dissimilar"))
                if (typeof message.dissimilar !== "boolean")
                    return "dissimilar: boolean expected";
            if (message.response != null && message.hasOwnProperty("response"))
        ...
        Feedback.fromObject = function fromObject(object) {
            if (object instanceof $root.feedlightpb.Feedback)
                return object;
            ...
            if (object.dissimilar != null)
                message.dissimilar = Boolean(object.dissimilar);
         ...
         * @memberof feedlightpb.Feedback
         * @static
         * @param {feedlightpb.Feedback} message Feedback
        ...
        Feedback.toObject = function toObject(message, options) {
            ...
            if (message.dissimilar != null && message.hasOwnProperty("dissimilar"))
                object.dissimilar = message.dissimilar;
            if (message.response != null && message.hasOwnProperty("response"))
    ...
    feedlightpb.SimilarFeedbackRequest = (function() {

        /**
         * Properties of a SimilarFeedbackRequest.
         * @memberof feedlightpb
         * @interface ISimilarFeedbackRequest
         * @property {string|null} [domain] SimilarFeedbackRequest domain
         * @property {feedlightpb.IFeedback|null} [feedback] SimilarFeedbackRequest feedback
         */

        /**
         * Constructs a new SimilarFeedbackRequest.
         * @memberof feedlightpb
         * @classdesc Represents a SimilarFeedbackRequest.
         * @implements ISimilarFeedbackRequest
         * @constructor
         * @param {feedlightpb.ISimilarFeedbackRequest=} [properties] Properties to set
         */
        function SimilarFeedbackRequest(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * SimilarFeedbackRequest domain.
         * @member {string} domain
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @instance
         */
        SimilarFeedbackRequest.prototype.domain = "";

        /**
         * SimilarFeedbackRequest feedback.
         * @member {feedlightpb.IFeedback|null|undefined} feedback
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @instance
         */
        SimilarFeedbackRequest.prototype.feedback = null;

        /**
         * Creates a new SimilarFeedbackRequest instance using the specified properties.
         * @function create
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {feedlightpb.ISimilarFeedbackRequest=} [properties] Properties to set
         * @returns {feedlightpb.SimilarFeedbackRequest} SimilarFeedbackRequest instance
         */
        SimilarFeedbackRequest.create = function create(properties) {
            return new SimilarFeedbackRequest(properties);
        };

        /**
         * Encodes the specified SimilarFeedbackRequest message. Does not implicitly {@link feedlightpb.SimilarFeedbackRequest.verify|verify} messages.
         * @function encode
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {feedlightpb.ISimilarFeedbackRequest} message SimilarFeedbackRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SimilarFeedbackRequest.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.feedback != null && message.hasOwnProperty("feedback"))
        ...
        /**
         * Encodes the specified SimilarFeedbackRequest message, length delimited. Does not implicitly {@link feedlightpb.SimilarFeedbackRequest.verify|verify} messages.
         * @function encodeDelimited
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {feedlightpb.ISimilarFeedbackRequest} message SimilarFeedbackRequest message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SimilarFeedbackRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SimilarFeedbackRequest message from the specified reader or buffer.
         * @function decode
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {feedlightpb.SimilarFeedbackRequest} SimilarFeedbackRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SimilarFeedbackRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.feedlightpb.SimilarFeedbackRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 2:
        ...
        /**
         * Decodes a SimilarFeedbackRequest message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SimilarFeedbackRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SimilarFeedbackRequest message.
         * @function verify
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SimilarFeedbackRequest.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.domain != null && message.hasOwnProperty("domain"))
        ...
        /**
         * Creates a SimilarFeedbackRequest message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {feedlightpb.SimilarFeedbackRequest} SimilarFeedbackRequest
         */
        SimilarFeedbackRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.feedlightpb.SimilarFeedbackRequest)
                return object;
            let message = new $root.feedlightpb.SimilarFeedbackRequest();
            if (object.domain != null)
                message.domain = String(object.domain);
            if (object.feedback != null) {
                if (typeof object.feedback !== "object")
                    throw TypeError(".feedlightpb.SimilarFeedbackRequest.feedback: object expected");
        ...
        /**
         * Creates a plain object from a SimilarFeedbackRequest message. Also converts values to other types if specified.
         * @function toObject
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @static
         * @param {feedlightpb.SimilarFeedbackRequest} message SimilarFeedbackRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SimilarFeedbackRequest.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this SimilarFeedbackRequest to JSON.
         * @function toJSON
         * @memberof feedlightpb.SimilarFeedbackRequest
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SimilarFeedbackRequest.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return SimilarFeedbackRequest;
    })();

    feedlightpb.SimilarFeedbackResponse = (function() {

        /**
         * Properties of a SimilarFeedbackResponse.
         * @memberof feedlightpb
         * @interface ISimilarFeedbackResponse
         * @property {Array.<feedlightpb.IFeedback>|null} [feedback] SimilarFeedbackResponse feedback
         */

        /**
         * Constructs a new SimilarFeedbackResponse.
         * @memberof feedlightpb
         * @classdesc Represents a SimilarFeedbackResponse.
         * @implements ISimilarFeedbackResponse
         * @constructor
         * @param {feedlightpb.ISimilarFeedbackResponse=} [properties] Properties to set
         */
        function SimilarFeedbackResponse(properties) {
            this.feedback = [];
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * SimilarFeedbackResponse feedback.
         * @member {Array.<feedlightpb.IFeedback>} feedback
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @instance
         */
        SimilarFeedbackResponse.prototype.feedback = $util.emptyArray;

        /**
         * Creates a new SimilarFeedbackResponse instance using the specified properties.
         * @function create
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {feedlightpb.ISimilarFeedbackResponse=} [properties] Properties to set
         * @returns {feedlightpb.SimilarFeedbackResponse} SimilarFeedbackResponse instance
         */
        SimilarFeedbackResponse.create = function create(properties) {
            return new SimilarFeedbackResponse(properties);
        };

        /**
         * Encodes the specified SimilarFeedbackResponse message. Does not implicitly {@link feedlightpb.SimilarFeedbackResponse.verify|verify} messages.
         * @function encode
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {feedlightpb.ISimilarFeedbackResponse} message SimilarFeedbackResponse message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SimilarFeedbackResponse.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.feedback != null && message.feedback.length)
                for (let i = 0; i < message.feedback.length; ++i)
                    $root.feedlightpb.Feedback.encode(message.feedback[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified SimilarFeedbackResponse message, length delimited. Does not implicitly {@link feedlightpb.SimilarFeedbackResponse.verify|verify} messages.
         * @function encodeDelimited
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {feedlightpb.ISimilarFeedbackResponse} message SimilarFeedbackResponse message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SimilarFeedbackResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SimilarFeedbackResponse message from the specified reader or buffer.
         * @function decode
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {feedlightpb.SimilarFeedbackResponse} SimilarFeedbackResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SimilarFeedbackResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.feedlightpb.SimilarFeedbackResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.feedback && message.feedback.length))
                        message.feedback = [];
                    message.feedback.push($root.feedlightpb.Feedback.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a SimilarFeedbackResponse message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SimilarFeedbackResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SimilarFeedbackResponse message.
         * @function verify
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SimilarFeedbackResponse.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.feedback != null && message.hasOwnProperty("feedback")) {
                ...
                for (let i = 0; i < message.feedback.length; ++i) {
                    let error = $root.feedlightpb.Feedback.verify(message.feedback[i]);
                    if (error)
                        return "feedback." + error;
                }
            }
        ...
        /**
         * Creates a SimilarFeedbackResponse message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {feedlightpb.SimilarFeedbackResponse} SimilarFeedbackResponse
         */
        SimilarFeedbackResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.feedlightpb.SimilarFeedbackResponse)
                return object;
            let message = new $root.feedlightpb.SimilarFeedbackResponse();
            if (object.feedback) {
                if (!Array.isArray(object.feedback))
                    throw TypeError(".feedlightpb.SimilarFeedbackResponse.feedback: array expected");
                message.feedback = [];
                for (let i = 0; i < object.feedback.length; ++i) {
                    if (typeof object.feedback[i] !== "object")
                        throw TypeError(".feedlightpb.SimilarFeedbackResponse.feedback: object expected");
                    message.feedback[i] = $root.feedlightpb.Feedback.fromObject(object.feedback[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a SimilarFeedbackResponse message. Also converts values to other types if specified.
         * @function toObject
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @static
         * @param {feedlightpb.SimilarFeedbackResponse} message SimilarFeedbackResponse
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SimilarFeedbackResponse.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            ...
            if (message.feedback && message.feedback.length) {
                ...
                for (let j = 0; j < message.feedback.length; ++j)
                    object.feedback[j] = $root.feedlightpb.Feedback.toObject(message.feedback[j], options);
            }
            return object;
        };

        /**
         * Converts this SimilarFeedbackResponse to JSON.
         * @function toJSON
         * @memberof feedlightpb.SimilarFeedbackResponse
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SimilarFeedbackResponse.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return SimilarFeedbackResponse;
    })();

    feedlightpb.SubmitFeedbackRequest = (function() {

        /**
         * Properties of a SubmitFeedbackRequest.
         * @memberof feedlightpb
         * @interface ISubmitFeedbackRequest
         * @property {string|null} [domain] SubmitFeedbackRequest domain
         * @property {string|null} [email] SubmitFeedbackRequest email
         * @property {feedlightpb.IFeedback|null} [feedback] SubmitFeedbackRequest feedback
         * @property {Array.<feedlightpb.IFeedback>|null} [similar] SubmitFeedbackRequest similar
         */
         ...
         * @constructor
         * @param {feedlightpb.ISubmitFeedbackRequest=} [properties] Properties to set
         */
        ...
        /**
         * SubmitFeedbackRequest domain.
         * @member {string} domain
         * @memberof feedlightpb.SubmitFeedbackRequest
         * @instance
         */
        SubmitFeedbackRequest.prototype.domain = "";

        /**
         * SubmitFeedbackRequest email.
         * @member {string} email
         * @memberof feedlightpb.SubmitFeedbackRequest
         * @instance
         */
        SubmitFeedbackRequest.prototype.email = "";
        ...
        /**
         * SubmitFeedbackRequest similar.
         * @member {Array.<feedlightpb.IFeedback>} similar
         * @memberof feedlightpb.SubmitFeedbackRequest
         * @instance
         */
        SubmitFeedbackRequest.prototype.similar = $util.emptyArray;
         ...
         * @static
         * @param {feedlightpb.ISubmitFeedbackRequest=} [properties] Properties to set
         * @returns {feedlightpb.SubmitFeedbackRequest} SubmitFeedbackRequest instance
         */
        ...
        /**
         * Encodes the specified SubmitFeedbackRequest message. Does not implicitly {@link feedlightpb.SubmitFeedbackRequest.verify|verify} messages.
         * @function encode
         * @memberof feedlightpb.SubmitFeedbackRequest
         * @static
         * @param {feedlightpb.ISubmitFeedbackRequest} message SubmitFeedbackRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SubmitFeedbackRequest.encode = function encode(message, writer) {
            ...
            if (message.feedback != null && message.hasOwnProperty("feedback"))
                $root.feedlightpb.Feedback.encode(message.feedback, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        ...
        /**
         * Encodes the specified SubmitFeedbackRequest message, length delimited. Does not implicitly {@link feedlightpb.SubmitFeedbackRequest.verify|verify} messages.
         * @function encodeDelimited
         * @memberof feedlightpb.SubmitFeedbackRequest
         * @static
         * @param {feedlightpb.ISubmitFeedbackRequest} message SubmitFeedbackRequest message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SubmitFeedbackRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {feedlightpb.SubmitFeedbackRequest} SubmitFeedbackRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SubmitFeedbackRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.feedlightpb.SubmitFeedbackRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 4:
        ...
        SubmitFeedbackRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.feedlightpb.SubmitFeedbackRequest)
                return object;
            let message = new $root.feedlightpb.SubmitFeedbackRequest();
            if (object.domain != null)
                message.domain = String(object.domain);
            ...
            if (object.feedback != null) {
                if (typeof object.feedback !== "object")
                    throw TypeError(".feedlightpb.SubmitFeedbackRequest.feedback: object expected");
                message.feedback = $root.feedlightpb.Feedback.fromObject(object.feedback);
            }
            if (object.similar) {
                if (!Array.isArray(object.similar))
                    throw TypeError(".feedlightpb.SubmitFeedbackRequest.similar: array expected");
                message.similar = [];
                for (let i = 0; i < object.similar.length; ++i) {
                    if (typeof object.similar[i] !== "object")
                        throw TypeError(".feedlightpb.SubmitFeedbackRequest.similar: object expected");
         ...
         * @memberof feedlightpb.SubmitFeedbackRequest
         * @static
         * @param {feedlightpb.SubmitFeedbackRequest} message SubmitFeedbackRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    feedlightpb.SubmitFeedbackResponse = (function() {
         ...
         * @constructor
         * @param {feedlightpb.ISubmitFeedbackResponse=} [properties] Properties to set
         */
         ...
         * @static
         * @param {feedlightpb.ISubmitFeedbackResponse=} [properties] Properties to set
         * @returns {feedlightpb.SubmitFeedbackResponse} SubmitFeedbackResponse instance
         */
        ...
        /**
         * Encodes the specified SubmitFeedbackResponse message. Does not implicitly {@link feedlightpb.SubmitFeedbackResponse.verify|verify} messages.
         * @function encode
         * @memberof feedlightpb.SubmitFeedbackResponse
         * @static
         * @param {feedlightpb.ISubmitFeedbackResponse} message SubmitFeedbackResponse message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified SubmitFeedbackResponse message, length delimited. Does not implicitly {@link feedlightpb.SubmitFeedbackResponse.verify|verify} messages.
         * @function encodeDelimited
         * @memberof feedlightpb.SubmitFeedbackResponse
         * @static
         * @param {feedlightpb.ISubmitFeedbackResponse} message SubmitFeedbackResponse message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SubmitFeedbackResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {feedlightpb.SubmitFeedbackResponse} SubmitFeedbackResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SubmitFeedbackResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.feedlightpb.SubmitFeedbackResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
         ...
         * @memberof feedlightpb.SubmitFeedbackResponse
         * @static
         * @param {feedlightpb.SubmitFeedbackResponse} message SubmitFeedbackResponse
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    feedlightpb.FeedbackService = (function() {
         ...
         */
        FeedbackService.create = function create(rpcImpl, requestDelimited, responseDelimited) {
            return new this(rpcImpl, requestDelimited, responseDelimited);
        };

        /**
         * Callback as used by {@link feedlightpb.FeedbackService#similarFeedback}.
         * @memberof feedlightpb.FeedbackService
         * @typedef SimilarFeedbackCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {feedlightpb.SimilarFeedbackResponse} [response] SimilarFeedbackResponse
         */

        /**
         * Calls SimilarFeedback.
         * @function similarFeedback
         * @memberof feedlightpb.FeedbackService
         * @instance
         * @param {feedlightpb.ISimilarFeedbackRequest} request SimilarFeedbackRequest message or plain object
         * @param {feedlightpb.FeedbackService.SimilarFeedbackCallback} callback Node-style callback called with the error, if any, and SimilarFeedbackResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(FeedbackService.prototype.similarFeedback = function similarFeedback(request, callback) {
            return this.rpcCall(similarFeedback, $root.feedlightpb.SimilarFeedbackRequest, $root.feedlightpb.SimilarFeedbackResponse, request, callback);
        }, "name", { value: "SimilarFeedback" });
         ...
         * @instance
         * @param {feedlightpb.ISimilarFeedbackRequest} request SimilarFeedbackRequest message or plain object
         * @returns {Promise<feedlightpb.SimilarFeedbackResponse>} Promise
         * @variation 2
         */

        /**
         * Callback as used by {@link feedlightpb.FeedbackService#submitFeedback}.
         * @memberof feedlightpb.FeedbackService
         * @typedef SubmitFeedbackCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {feedlightpb.SubmitFeedbackResponse} [response] SubmitFeedbackResponse
         */
         ...
         * @param {feedlightpb.FeedbackService.SubmitFeedbackCallback} callback Node-style callback called with the error, if any, and SubmitFeedbackResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(FeedbackService.prototype.submitFeedback = function submitFeedback(request, callback) {
            return this.rpcCall(submitFeedback, $root.feedlightpb.SubmitFeedbackRequest, $root.feedlightpb.SubmitFeedbackResponse, request, callback);
    ...
    feedlightpb.Status = (function() {
         ...
         * @static
         * @param {feedlightpb.IStatus=} [properties] Properties to set
         * @returns {feedlightpb.Status} Status instance
         */
        ...
        /**
         * Encodes the specified Status message. Does not implicitly {@link feedlightpb.Status.verify|verify} messages.
         * @function encode
         * @memberof feedlightpb.Status
         * @static
         * @param {feedlightpb.IStatus} message Status message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Status message, length delimited. Does not implicitly {@link feedlightpb.Status.verify|verify} messages.
         * @function encodeDelimited
         * @memberof feedlightpb.Status
         * @static
         * @param {feedlightpb.IStatus} message Status message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {feedlightpb.Status} Status
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Status.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.feedlightpb.Status();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Status.fromObject = function fromObject(object) {
            if (object instanceof $root.feedlightpb.Status)
                return object;
            let message = new $root.feedlightpb.Status();
            if (object.code != null)
         ...
         * @memberof feedlightpb.Status
         * @static
         * @param {feedlightpb.Status} message Status
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
